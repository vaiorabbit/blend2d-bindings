...
module Blend2D
  ...
  BL_FONT_COVERAGE_GROUP_BASIC_LATIN = 0
  BL_FONT_COVERAGE_GROUP_LATIN1_SUPPLEMENT = 1
  BL_FONT_COVERAGE_GROUP_LATIN_EXTENDED_A = 2
  BL_FONT_COVERAGE_GROUP_LATIN_EXTENDED_B = 3
  BL_FONT_COVERAGE_GROUP_IPA_EXTENSIONS = 4
  BL_FONT_COVERAGE_GROUP_SPACING_MODIFIER_LETTERS = 5
  BL_FONT_COVERAGE_GROUP_COMBINING_DIACRITICAL_MARKS = 6
  BL_FONT_COVERAGE_GROUP_GREEK_AND_COPTIC = 7
  BL_FONT_COVERAGE_GROUP_COPTIC = 8
  BL_FONT_COVERAGE_GROUP_CYRILLIC = 9
  BL_FONT_COVERAGE_GROUP_ARMENIAN = 10
  BL_FONT_COVERAGE_GROUP_HEBREW = 11
  BL_FONT_COVERAGE_GROUP_VAI = 12
  BL_FONT_COVERAGE_GROUP_ARABIC = 13
  BL_FONT_COVERAGE_GROUP_NKO = 14
  BL_FONT_COVERAGE_GROUP_DEVANAGARI = 15
  BL_FONT_COVERAGE_GROUP_BENGALI = 16
  BL_FONT_COVERAGE_GROUP_GURMUKHI = 17
  BL_FONT_COVERAGE_GROUP_GUJARATI = 18
  BL_FONT_COVERAGE_GROUP_ORIYA = 19
  BL_FONT_COVERAGE_GROUP_TAMIL = 20
  BL_FONT_COVERAGE_GROUP_TELUGU = 21
  BL_FONT_COVERAGE_GROUP_KANNADA = 22
  BL_FONT_COVERAGE_GROUP_MALAYALAM = 23
  BL_FONT_COVERAGE_GROUP_THAI = 24
  BL_FONT_COVERAGE_GROUP_LAO = 25
  BL_FONT_COVERAGE_GROUP_GEORGIAN = 26
  BL_FONT_COVERAGE_GROUP_BALINESE = 27
  BL_FONT_COVERAGE_GROUP_HANGUL_JAMO = 28
  BL_FONT_COVERAGE_GROUP_LATIN_EXTENDED_ADDITIONAL = 29
  BL_FONT_COVERAGE_GROUP_GREEK_EXTENDED = 30
  BL_FONT_COVERAGE_GROUP_GENERAL_PUNCTUATION = 31
  BL_FONT_COVERAGE_GROUP_SUPERSCRIPTS_AND_SUBSCRIPTS = 32
  BL_FONT_COVERAGE_GROUP_CURRENCY_SYMBOLS = 33
  BL_FONT_COVERAGE_GROUP_COMBINING_DIACRITICAL_MARKS_FOR_SYMBOLS = 34
  BL_FONT_COVERAGE_GROUP_LETTERLIKE_SYMBOLS = 35
  BL_FONT_COVERAGE_GROUP_NUMBER_FORMS = 36
  BL_FONT_COVERAGE_GROUP_ARROWS = 37
  BL_FONT_COVERAGE_GROUP_MATHEMATICAL_OPERATORS = 38
  BL_FONT_COVERAGE_GROUP_MISCELLANEOUS_TECHNICAL = 39
  BL_FONT_COVERAGE_GROUP_CONTROL_PICTURES = 40
  BL_FONT_COVERAGE_GROUP_OPTICAL_CHARACTER_RECOGNITION = 41
  BL_FONT_COVERAGE_GROUP_ENCLOSED_ALPHANUMERICS = 42
  BL_FONT_COVERAGE_GROUP_BOX_DRAWING = 43
  BL_FONT_COVERAGE_GROUP_BLOCK_ELEMENTS = 44
  BL_FONT_COVERAGE_GROUP_GEOMETRIC_SHAPES = 45
  BL_FONT_COVERAGE_GROUP_MISCELLANEOUS_SYMBOLS = 46
  BL_FONT_COVERAGE_GROUP_DINGBATS = 47
  BL_FONT_COVERAGE_GROUP_CJK_SYMBOLS_AND_PUNCTUATION = 48
  BL_FONT_COVERAGE_GROUP_HIRAGANA = 49
  BL_FONT_COVERAGE_GROUP_KATAKANA = 50
  BL_FONT_COVERAGE_GROUP_BOPOMOFO = 51
  BL_FONT_COVERAGE_GROUP_HANGUL_COMPATIBILITY_JAMO = 52
  BL_FONT_COVERAGE_GROUP_PHAGS_PA = 53
  BL_FONT_COVERAGE_GROUP_ENCLOSED_CJK_LETTERS_AND_MONTHS = 54
  BL_FONT_COVERAGE_GROUP_CJK_COMPATIBILITY = 55
  BL_FONT_COVERAGE_GROUP_HANGUL_SYLLABLES = 56
  BL_FONT_COVERAGE_GROUP_NON_PLANE = 57
  BL_FONT_COVERAGE_GROUP_PHOENICIAN = 58
  BL_FONT_COVERAGE_GROUP_CJK_UNIFIED_IDEOGRAPHS = 59
  BL_FONT_COVERAGE_GROUP_PRIVATE_USE_PLANE0 = 60
  BL_FONT_COVERAGE_GROUP_CJK_STROKES = 61
  BL_FONT_COVERAGE_GROUP_ALPHABETIC_PRESENTATION_FORMS = 62
  BL_FONT_COVERAGE_GROUP_ARABIC_PRESENTATION_FORMS_A = 63
  BL_FONT_COVERAGE_GROUP_COMBINING_HALF_MARKS = 64
  BL_FONT_COVERAGE_GROUP_VERTICAL_FORMS = 65
  BL_FONT_COVERAGE_GROUP_SMALL_FORM_VARIANTS = 66
  BL_FONT_COVERAGE_GROUP_ARABIC_PRESENTATION_FORMS_B = 67
  BL_FONT_COVERAGE_GROUP_HALFWIDTH_AND_FULLWIDTH_FORMS = 68
  BL_FONT_COVERAGE_GROUP_SPECIALS = 69
  BL_FONT_COVERAGE_GROUP_TIBETAN = 70
  BL_FONT_COVERAGE_GROUP_SYRIAC = 71
  BL_FONT_COVERAGE_GROUP_THAANA = 72
  BL_FONT_COVERAGE_GROUP_SINHALA = 73
  BL_FONT_COVERAGE_GROUP_MYANMAR = 74
  BL_FONT_COVERAGE_GROUP_ETHIOPIC = 75
  BL_FONT_COVERAGE_GROUP_CHEROKEE = 76
  BL_FONT_COVERAGE_GROUP_UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS = 77
  BL_FONT_COVERAGE_GROUP_OGHAM = 78
  BL_FONT_COVERAGE_GROUP_RUNIC = 79
  BL_FONT_COVERAGE_GROUP_KHMER = 80
  BL_FONT_COVERAGE_GROUP_MONGOLIAN = 81
  BL_FONT_COVERAGE_GROUP_BRAILLE_PATTERNS = 82
  BL_FONT_COVERAGE_GROUP_YI_SYLLABLES_AND_RADICALS = 83
  BL_FONT_COVERAGE_GROUP_TAGALOG_HANUNOO_BUHID_TAGBANWA = 84
  BL_FONT_COVERAGE_GROUP_OLD_ITALIC = 85
  BL_FONT_COVERAGE_GROUP_GOTHIC = 86
  BL_FONT_COVERAGE_GROUP_DESERET = 87
  BL_FONT_COVERAGE_GROUP_MUSICAL_SYMBOLS = 88
  BL_FONT_COVERAGE_GROUP_MATHEMATICAL_ALPHANUMERIC_SYMBOLS = 89
  BL_FONT_COVERAGE_GROUP_PRIVATE_USE_PLANE_15_16 = 90
  BL_FONT_COVERAGE_GROUP_VARIATION_SELECTORS = 91
  BL_FONT_COVERAGE_GROUP_TAGS = 92
  BL_FONT_COVERAGE_GROUP_LIMBU = 93
  BL_FONT_COVERAGE_GROUP_TAI_LE = 94
  BL_FONT_COVERAGE_GROUP_NEW_TAI_LUE = 95
  BL_FONT_COVERAGE_GROUP_BUGINESE = 96
  BL_FONT_COVERAGE_GROUP_GLAGOLITIC = 97
  BL_FONT_COVERAGE_GROUP_TIFINAGH = 98
  BL_FONT_COVERAGE_GROUP_YIJING_HEXAGRAM_SYMBOLS = 99
  BL_FONT_COVERAGE_GROUP_SYLOTI_NAGRI = 100
  BL_FONT_COVERAGE_GROUP_LINEAR_B_SYLLABARY_AND_IDEOGRAMS = 101
  BL_FONT_COVERAGE_GROUP_ANCIENT_GREEK_NUMBERS = 102
  BL_FONT_COVERAGE_GROUP_UGARITIC = 103
  BL_FONT_COVERAGE_GROUP_OLD_PERSIAN = 104
  BL_FONT_COVERAGE_GROUP_SHAVIAN = 105
  BL_FONT_COVERAGE_GROUP_OSMANYA = 106
  BL_FONT_COVERAGE_GROUP_CYPRIOT_SYLLABARY = 107
  BL_FONT_COVERAGE_GROUP_KHAROSHTHI = 108
  BL_FONT_COVERAGE_GROUP_TAI_XUAN_JING_SYMBOLS = 109
  BL_FONT_COVERAGE_GROUP_CUNEIFORM = 110
  BL_FONT_COVERAGE_GROUP_COUNTING_ROD_NUMERALS = 111
  BL_FONT_COVERAGE_GROUP_SUNDANESE = 112
  BL_FONT_COVERAGE_GROUP_LEPCHA = 113
  BL_FONT_COVERAGE_GROUP_OL_CHIKI = 114
  BL_FONT_COVERAGE_GROUP_SAURASHTRA = 115
  BL_FONT_COVERAGE_GROUP_KAYAH_LI = 116
  BL_FONT_COVERAGE_GROUP_REJANG = 117
  BL_FONT_COVERAGE_GROUP_CHAM = 118
  BL_FONT_COVERAGE_GROUP_ANCIENT_SYMBOLS = 119
  BL_FONT_COVERAGE_GROUP_PHAISTOS_DISC = 120
  BL_FONT_COVERAGE_GROUP_CARIAN_LYCIAN_LYDIAN = 121
  BL_FONT_COVERAGE_GROUP_DOMINO_AND_MAHJONG_TILES = 122
  BL_FONT_COVERAGE_GROUP_INTERNAL_USAGE_123 = 123
  BL_FONT_COVERAGE_GROUP_INTERNAL_USAGE_124 = 124
  BL_FONT_COVERAGE_GROUP_INTERNAL_USAGE_125 = 125
  BL_FONT_COVERAGE_GROUP_INTERNAL_USAGE_126 = 126
  BL_FONT_COVERAGE_GROUP_INTERNAL_USAGE_127 = 127
  BL_FONT_COVERAGE_GROUP_MAX_VALUE = 127
  BL_FONT_COVERAGE_GROUP_FORCE_UINT = -1
  ...
  typedef :int, :BLFontCoverageGroup
  ...
  class BLFontCoverageInfo < FFI::Struct
    layout(
      :data, [:uint, 4],
    )
    def data = self[:data]
    ...
    def self.create_as(_data_)
      instance = BLFontCoverageInfo.new
